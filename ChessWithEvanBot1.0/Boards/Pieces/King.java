...
public class King extends ChessPiece
{
    ...
    { 
        if(isLegalCastle(m, b, pb, cc)) return new Castle(getPosition(),m,getType(), b, isCheck(m,b,cc));
        else return new NormalMove(getPosition(), m, getType(),b, false);
    }
    public boolean isLegalMove(int i, int[] b, ChessPiece[] pb, CheckChecker cc, Stack<Move> mpl){
