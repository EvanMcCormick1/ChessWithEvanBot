...
public abstract class ChessPiece 
{
    ...
    public abstract Move generateMove(int m, int[] b, ChessPiece[] pb, Stack<Move> mpl, CheckChecker cc);
    public abstract boolean isLegalMove(int o, int[] b, ChessPiece[] pb, CheckChecker c, Stack<Move> mpl);
    public abstract boolean isCheck(int o, int[] b, CheckChecker c);
    public abstract boolean isCapture(int o, int[] b);
    public abstract int[] possibleMoves(int[] b, ChessPiece[] pb, CheckChecker c, Stack<Move> mpl);
    ...
    public ArrayList<Move> generateLegalMoves(int[] b, ChessPiece[] pb, CheckChecker cc, Stack<Move> mpl)
    {
    ...
    public ArrayList<Move> generateChecks(int[] b, ChessPiece[] pb, CheckChecker cc, Stack<Move> mpl){
        ArrayList<Move> result = new ArrayList<>();
        int[] moves = possibleMoves(b,pb,cc,mpl);
    ...
    public ArrayList<Move> generateCaptures(int[] b, ChessPiece[] pb, CheckChecker cc, Stack<Move> mpl){
        ArrayList<Move> result = new ArrayList<>();
        int[] moves = possibleMoves(b,pb,cc,mpl);
        for(int i=0; i< moves.length;i++) {
    ...
    public ArrayList<Move> generateCheckCaptures(int[] b, ChessPiece[] pb, CheckChecker cc, Stack<Move> mpl){
        ArrayList<Move> result = new ArrayList<>();
        int[] moves = possibleMoves(b, pb, cc, mpl);
        for(int i:moves){
